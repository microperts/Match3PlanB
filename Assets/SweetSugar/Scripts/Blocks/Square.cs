...
//TODO: Add new target
    ...
    public class Square : MonoBehaviour, ISquareItemCommon, IField, IMarmaladeTargetable
    {
                        ...
                        if (SpawnerType.SpawnersType != Spawners.Ingredient && SpawnerType.SpawnersType_2 != Spawners.Ingredient)
                        {
                            ...
                            switch (res)
                            {
                                ...
                                case Spawners.TimeBomb:
                                    ...
                                    GenItem(itemType: ItemsTypes.TimeBomb);
                                ...
                                case Spawners.HORIZONTAL_STRIPED:
                                    GenItem(itemType: ItemsTypes.HORIZONTAL_STRIPED);
                                    break;
                                case Spawners.VERTICAL_STRIPED:
                                    GenItem(itemType: ItemsTypes.VERTICAL_STRIPED);
                                    break;
                                case Spawners.MARMALADE:
                                    GenItem(itemType: ItemsTypes.MARMALADE);
                                    break;
                                case Spawners.MULTICOLOR:
                                    GenItem(itemType: ItemsTypes.MULTICOLOR);
                                    break;
                                default:
                                    break;
                            }
        ...
        public Item GenItem(bool falling = true, ItemsTypes itemType = ItemsTypes.NONE, int color = -1, ItemForEditor squareBlockItem=null)
        {
            ...
            {
                ///- Disabled Bonus Generation
                item = ObjectPooler.Instance.GetPooledObject(/*itemType.ToString()*/"Item", this);
                ...
                switch (itemType)
                {
                    ...
                    case ItemsTypes.PACKAGE:
                        // match 4
                        LevelManager.THIS.levelData.limit += 1;
                        Debug.Log("4 match");
                        break;
